...
const SCRIPTS = [
    ...
    // {
    //     name: "多号签到脚本",
    //     js_url: "https://raw.githubusercontent.com/QinyRui/QYR-/main/jiuhao/Ninebot_Sign_Multi_v1.0.js"
    // }
];
...
const LOGO_URL = "https://raw.githubusercontent.com/QinyRui/QYR-/jiuhao/logo_128.png"; // 可选九号LOGO

// Telegram 配置（可选）
const TELEGRAM_ENABLE = false; // true 启用
        ...
        for(const sc of SCRIPTS){
            const data = await new Promise((resolve,reject)=>{
                $httpClient.get(sc.js_url,(err,resp,body)=>{
                    if(err||resp.status!==200) reject(err);
                    else resolve(body);
                });
            });
