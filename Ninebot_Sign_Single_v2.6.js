...
const KEY_DEBUGLV="ninebot.debugLevel";
...
const cfg={
  ...
  debugLevel:Number(readPS(KEY_DEBUGLV)||1)
};
if(!cfg.Authorization||!cfg.DeviceId){ notify(cfg.titlePrefix,"未配置 Token","请先抓包写入数据"); return $done(); }
