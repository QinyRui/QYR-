/***********************************************
 ...
 2025-11-30 修复版（增强调试、8 种进度条、插件优先）
...
/* Capture handling - match /status, /sign, /service/2/app_log/ */
...
/* Read config: prefer plugin arg (if present), fallback to BoxJS key */
...
(async () => {
  try {
    ...
    // 3) 分享任务（如果 shareTaskUrl 存在） -> 查询流水或尝试自动完成+领取
