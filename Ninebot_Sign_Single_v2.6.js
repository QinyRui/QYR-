...
#!desc = 抓包自动写入教程→打开 Loon 抓包开关→打开九号 APP 签到页或分享动作，会自动写入 BoxJS
...
# 【新增】：日志等级控制，默认 info，可选 debug/warn/error
logLevel = select, "info", "debug", "warn", "error", tag=脚本日志等级
